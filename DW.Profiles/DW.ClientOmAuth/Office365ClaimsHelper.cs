...
namespace DW.ClientOmAuth
{
    public class Office365ClaimsHelper
    {
        #region Properties
        ...
        #region Constructors
        public Office365ClaimsHelper(string host, string username, string password)
            : this(new Uri(host), username, password)
        {

        }
        public Office365ClaimsHelper(Uri host, string username, string password)
        {
            _host = host;
            _username = username;
            _password = password;
        ...
        public Office365ClaimsHelper(Uri host, string username, string password, bool useRtfa)
        {
            _host = host;
            _username = username;
            _password = password;
